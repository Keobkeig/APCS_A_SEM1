...
public class MazeWithExplorer {
    ...
    private int east_offset;
    private int south_offset; 
    ...
    public MazeWithExplorer(
        ...
        // populating the explorer location fields
        east_offset = explorerOffsetEast;
        south_offset = explorerOffsetSouth;
           ...
           ; offsetSouth++) {
            ...
            for( int offsetEast = 0
               ...
               ; offsetEast++) {
                ...
                String charChoice = noEx; /* stub. Sometimes
                charChoice should be exOnTop */

                /* choose the appropriate character set, based
                   on the explorer's position
                */
                // if the explorer is on the current maze tile we are converting to string
                boolean explorerHere = offsetSouth == south_offset && offsetEast == east_offset;
                if(explorerHere){
                  charChoice = exOnTop;
                }
    ...
    public int explorerIsOnA() {
      return maze[south_offset][east_offset];
    }
}