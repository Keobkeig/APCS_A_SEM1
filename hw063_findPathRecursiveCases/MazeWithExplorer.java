...
public class MazeWithExplorer {
    ...
    */
    ...
    public /* instance */ void dropBreadcrumbAndGo( int direction) {
        ...
        // stub. Your code here.
        maze[explorerOffsetSouth][explorerOffsetEast] = BREADCRUMB;

        // Move the explorer.  Better Java might use switch / case
        // stub. Your code here.
        if (direction == EAST)         explorerOffsetEast++;
        else if (direction == NORTH)   explorerOffsetSouth--;
        else if (direction == WEST)    explorerOffsetEast--;
        else                          explorerOffsetSouth++; 
    }
}
